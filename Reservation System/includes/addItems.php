...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_SESSION["userId"])) {
    ...
    try {
        ...
        if ($existingProduct) {
            ...
            $query = "UPDATE products SET quantity = :quantity, price = :price, images = :image WHERE product_name = :products AND users_id = :users_id";
        } else {
            //NEW ENTRY OF THE PRODUCT CHOSEN//NEW ENTRY OF THE PRODUCT CHOSEN//NEW ENTRY OF THE PRODUCT CHOSEN//NEW ENTRY OF THE PRODUCT CHOSEN//NEW ENTRY OF THE PRODUCT CHOSEN//
